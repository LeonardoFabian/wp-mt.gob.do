          ...
          $.notify(
            {
              ...
              title: "Actualizado: ",
              message:
                "Se han actualizado los datos del Encargado: " + data.encargado,
            },
            {
              placement: {
                from: "top",
          ...
          $.notify(
            {
              ...
              message:
                "Ha actualizado los datos de " + data.user_updated.display_name,
            },
            {
              placement: {
                from: "bottom",
              ...
              icon_type: "image",
              template:
                '<div data-notify="container" class="col-xs-11 col-sm-8 col-md-3 alert alert-{0}" role="alert">' +
