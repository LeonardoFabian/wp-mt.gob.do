...
<div class="had-container">
    ...
    <div class="row">
        <div class="col s12">
            ...
            <?php #TODO: Añadir boton "Crear nueva categoría" ?>
            ...
            <span style="font-size:16px; margin-top:5px;">Añadir nueva categoría</span>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col l12">
            ...
            <table class="responsive-table white highlight">
                ...
                <tbody>
                    <tr>
                        <td class="center"><img src="<?php echo INSTMT_PLUGIN_DIR_URL . 'admin/image/mime/folder.svg'; ?>" style="max-width:50px;" alt=""></td>
                        <td><a href="#"><span>Categoria X</span></a></td>
                        <td>1</td>
