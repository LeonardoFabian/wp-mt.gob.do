 ...
 */
if( ! class_exists( 'InstitucionalMT_Slideshow_Loader' )){

    class InstitucionalMT_Slideshow_Loader{
         ...
         * @since           1.0.0
         * @access          protected
         * @var             array       $actions        Arreglo de acciones registradas en WordPress que se ejecutan cuando se carga el plugin.
         */
        protected $actions;
         ...
         * @since           1.0.0
         * @access          protected
         * @var             array       $filters        Arreglo de filtros registrados en WordPress que se ejecutan cuando se carga el plugin.
         */
        protected $filters;
