...
function _themename_register_widgets()
{
    ...
    register_sidebar(array(
        ...
        'before_widget' => '<div id="%1$s" class="c-sidebar-widget %2$s mb-5">',
        'after_widget' => '</div>',
        'before_title' => '<h3 class="widget-title">',
        'after_title' => '</h3>'
    ));
    ...
    register_sidebar(array(
        ...
        'before_widget' => '<div id="%1$s" class="c-sidebar-widget %2$s mb-3">',
        'after_widget' => '</div>',
        'before_title' => '<h3 class="widget-title">',
        'after_title' => '</h3>'
    ));
    ...
    register_sidebar(array(
        ...
        'before_widget' => '<div class="c-sidebar-widget u-margin-bottom-20 text-justify col-md-12 col-lg-12" style="width:100%;">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3>',
    ));
