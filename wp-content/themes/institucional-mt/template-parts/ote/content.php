...
/**
 * Pagina de archivo para listar todas las Oficinas Territoriales
 * Se requiere tener instalado el plugin
 */

$custom_fields = get_post_meta($post->ID, '_instmt_ote');
                    ...
                    <table class="table table-borderless">
                        ...
                        <tbody>
                            ...
                            <?php if($dato['telefono'] != '') : ?>
                                ...
                                <td class="text-left">
                                    ...
                                    <?php if($dato['extension_1'] != '' ) : ?>
                                        <br>Ext.:&nbsp;<span class="text-muted"><?php echo $dato['extension_1'] ?></span>
                                    <?php endif; ?>
                            ...
                            <tr class="mt-1 opacity">
                                ...
                                <td class="text-left">
                                <span><strong>Horario de atención</strong></span><br>
