...
?>
        ...
        <div class="col-12 col-md-5 text-center">
            ...
            <div class="card map-card">
                ...
                <!-- Map -->
                <div id="<?php echo $this->get_field_id('map_uri'); ?>" class="z-depth-1-half map-container" style="height:150px">
                        ...
                        <table class="table table-borderless">
                            <tbody>
                                ...
                                <tr class="mt-2">
                                    ...
                                    <td class="text-left"><?php echo apply_filters('hour', $instance['hour']); ?></td>
                                </tr>
                            </tbody>
                        </table>
    ...
    ?>
        ...
        <p>
            ...
            <input type="text" name="<?php echo $this->get_field_name('map_uri'); ?>" id="<?php echo $this->get_field_id('map_uri'); ?>" value="<?php echo $instance['map_uri']; ?>" class="widefat" />
        </p>
        <p>
            ...
            <input type="text" name="<?php echo $this->get_field_name('float_btn_icon'); ?>" id="<?php echo $this->get_field_id('float_btn_icon'); ?>" value="<?php echo $instance['float_btn_icon']; ?>" class="widefat" />
        </p>
        <p>
        ...
        <p>
            ...
            <input type="text" name="<?php echo $this->get_field_name('contact_position'); ?>" id="<?php echo $this->get_field_id('contact_position'); ?>" value="<?php echo $instance['contact_position']; ?>" class="widefat" maxlengt="50" />
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('contact_phone'); ?>">Contact Phone</label><br />
            <input type="text" name="<?php echo $this->get_field_name('contact_phone'); ?>" id="<?php echo $this->get_field_id('contact_phone'); ?>" value="<?php echo $instance['contact_phone']; ?>" class="widefat" maxlengt="25" />
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('contact_mobile'); ?>">Contact Mobile</label><br />
            <input type="number" name="<?php echo $this->get_field_name('contact_mobile'); ?>" id="<?php echo $this->get_field_id('contact_mobile'); ?>" value="<?php echo $instance['contact_mobile']; ?>" class="widefat" maxlengt="11" />
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('address'); ?>">Contact Address</label><br />
            <input type="textarea" name="<?php echo $this->get_field_name('address'); ?>" id="<?php echo $this->get_field_id('address'); ?>" value="<?php echo $instance['address']; ?>" class="widefat" maxlengt="100" />
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('email'); ?>">Contact Email</label><br />
            <input type="email" name="<?php echo $this->get_field_name('email'); ?>" id="<?php echo $this->get_field_id('email'); ?>" value="<?php echo $instance['email']; ?>" class="widefat" maxlengt="100" />
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('hour'); ?>">Contact Phone</label><br />
            <input type="text" name="<?php echo $this->get_field_name('hour'); ?>" id="<?php echo $this->get_field_id('hour'); ?>" value="<?php echo $instance['hour']; ?>" class="widefat" maxlengt="25" />
        </p>
        <!-- 
        <p>
...
<?php
    ...
    public function update($new_instance, $old_instance)
    {
        ...
        $instance['map_uri'] = (!empty($new_instance['map_uri'])) ? strip_tags($new_instance['map_uri']) : '';
        $instance['float_btn_icon'] = (!empty($new_instance['float_btn_icon'])) ? strip_tags($new_instance['float_btn_icon']) : '';
