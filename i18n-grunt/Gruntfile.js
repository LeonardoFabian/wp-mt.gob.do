		...
		makepot: {
			target: {
				options: {
					...
					potFilename: 'institucionalmt-grunt.pot',              // Name of the POT file.
					type: 'wp-plugin',                      // Type of project (wp-plugin or wp-theme).
					exclude: ['file-1.php', 'file-2.php'], // List of files or directories to ignore.
					processPot: function( pot, options ) {
						pot.headers['report-msgid-bugs-to'] = 'https://www.linkedin.com/in/leonardofabian/';
						pot.headers['plural-forms'] = 'nplurals=2; plural=n != 1;';
						pot.headers['last-translator'] = 'Leonardo Fabian <ramonlfabian@gmail.com>\n';
						pot.headers['language-team'] = 'Leonardo Fabian <ramonlfabian@gmail.com>\n';
						pot.headers['x-poedit-basepath'] = '.\n';
						pot.headers['x-poedit-language'] = 'Spanish\n';
						pot.headers['x-poedit-country'] = 'REPUBLICA DOMINICANA\n';
